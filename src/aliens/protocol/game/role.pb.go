...
func (*GetUserInfo) Descriptor() ([]byte, []int) { return fileDescriptorRole, []int{0} }
...
func (*GetUserInfoRet) Descriptor() ([]byte, []int) { return fileDescriptorRole, []int{1} }

func (m *GetUserInfoRet) GetUser() *User {
	if m != nil {
		return m.User
	}
	return nil
...
func (*LoginRole) Descriptor() ([]byte, []int) { return fileDescriptorRole, []int{2} }
...
func (*LoginRoleRet) Descriptor() ([]byte, []int) { return fileDescriptorRole, []int{3} }
...
func (*CreateRole) Descriptor() ([]byte, []int) { return fileDescriptorRole, []int{4} }
...
func (*CreateRoleRet) Descriptor() ([]byte, []int) { return fileDescriptorRole, []int{5} }
...
func (*RemoveRole) Descriptor() ([]byte, []int) { return fileDescriptorRole, []int{6} }
...
func (*RemoveRoleRet) Descriptor() ([]byte, []int) { return fileDescriptorRole, []int{7} }

func init() {
	proto.RegisterType((*GetUserInfo)(nil), "game.get_user_info")
	proto.RegisterType((*GetUserInfoRet)(nil), "game.get_user_info_ret")
	proto.RegisterType((*LoginRole)(nil), "game.login_role")
	proto.RegisterType((*LoginRoleRet)(nil), "game.login_role_ret")
	proto.RegisterType((*CreateRole)(nil), "game.create_role")
	proto.RegisterType((*CreateRoleRet)(nil), "game.create_role_ret")
	proto.RegisterType((*RemoveRole)(nil), "game.remove_role")
	proto.RegisterType((*RemoveRoleRet)(nil), "game.remove_role_ret")
}
...
func (m *GetUserInfoRet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.User != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRole(dAtA, i, uint64(m.User.Size()))
...
func (m *LoginRoleRet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ServerTime != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintRole(dAtA, i, uint64(m.ServerTime))
	}
	return i, nil
}
...
func (m *LoginRoleRet) Size() (n int) {
	...
	if m.ServerTime != 0 {
		n += 1 + sovRole(uint64(m.ServerTime))
	}
	return n
}
...
var fileDescriptorRole = []byte{
	...
	,
}
