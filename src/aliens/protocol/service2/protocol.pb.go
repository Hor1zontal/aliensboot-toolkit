...
/*
	Package service2 is a generated protocol buffer package.
...
func (*Request2) Descriptor() ([]byte, []int) { return fileDescriptorProtocol, []int{0} }

func (m *Request2) GetNo() int32 {
	if m != nil && m.No != nil {
		return *m.No
	}
	return 0
...
func (m *Request2) GetSession() int32 {
...
func (m *Request2) GetRequest() string {
...
func (*Response2) Descriptor() ([]byte, []int) { return fileDescriptorProtocol, []int{1} }

func (m *Response2) GetNo() int32 {
	if m != nil && m.No != nil {
		return *m.No
	}
	return 0
...
func (m *Response2) GetSession() int32 {
	if m != nil && m.Session != nil {
		return *m.Session
	}
	return 0
...
func (m *Response2) GetResponse() string {
...
func init() {
	proto.RegisterType((*Request2)(nil), "service2.Request2")
	proto.RegisterType((*Response2)(nil), "service2.Response2")
}
...
type RPCServiceClient interface {
	Request(ctx context.Context, in *Request2, opts ...grpc.CallOption) (*Response2, error)
}
...
func (c *rPCServiceClient) Request(ctx context.Context, in *Request2, opts ...grpc.CallOption) (*Response2, error) {
	out := new(Response2)
	err := grpc.Invoke(ctx, "/service2.RPCService/request", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RPCServiceServer interface {
	Request(context.Context, *Request2) (*Response2, error)
}
...
func _RPCService_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service2.RPCService/Request",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RPCServiceServer).Request(ctx, req.(*Request2))
	}
	return interceptor(ctx, in, info, handler)
}

var _RPCService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "service2.RPCService",
...
var fileDescriptorProtocol = []byte{
	...
	0x8d, 0x94, 0xfc, 0xb8, 0x38, 0x82, 0x52, 0x0b, 0x4b, 0x53, 0x8b, 0x4b, 0x8c, 0x84, 0xf8, 0xb8,
	...
	0xa8, 0x89, 0x70, 0xbe, 0x91, 0x03, 0x17, 0x57, 0x50, 0x80, 0x73, 0x30, 0xc4, 0xc5, 0x42, 0x46,
	0x70, 0xab, 0x85, 0x84, 0xf4, 0x60, 0xde, 0xd0, 0x83, 0xf9, 0x41, 0x4a, 0x18, 0x59, 0x0c, 0x6a,
	0x80, 0x93, 0xc0, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38,
	0xe3, 0xb1, 0x1c, 0x03, 0x20, 0x00, 0x00, 0xff, 0xff, 0x10, 0x13, 0xc1, 0x8b, 0x11, 0x01, 0x00,
	0x00,
}
