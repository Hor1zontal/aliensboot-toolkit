...
../codegen -proto protocol.proto -template  ../templates/auth_common.template        -output ../../module/${MODULENAME}/service/handle.go     -overwrite true
...
#../codegen -proto protocol.proto -template ../templates/common_rpc.template -output ../../module/cluster/rpc/${MODULENAME}.go  -overwrite true